...
const DEFAULT_THEME = {
  ...
  fontSize: 14, topbarFontSize: 12, clockWidgetSize: 1, notesFontSize: 13, newNoteFontSize: 13, settingsFontSize: 13,
  sectionTitleFontSize: 11, linkFontSize: 12,
...
function applyTheme(t) {
  ...
  if (t.newNoteFontSize) s('--new-note-font-size',     t.newNoteFontSize + 'px')
  if (t.sectionTitleFontSize) s('--section-title-font-size', t.sectionTitleFontSize + 'px')
  if (t.linkFontSize)    s('--link-font-size',         t.linkFontSize + 'px')
