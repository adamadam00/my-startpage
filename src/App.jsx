...
export default function App() {
  ...
  useEffect(() => { 
    if (activeWs && session) {
      ...
      // Immediately show cached data for this workspace before fetch completes
      ...
      if (cachedSec.length > 0) setSections(cachedSec)
      if (cachedLnk.length > 0) setLinks(cachedLnk)
